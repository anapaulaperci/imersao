...
import { FileText, PenTool, ArrowLeft, Paperclip, Smile, Mic, Send } from "lucide-react";
                ...
                <div className="flex flex-col lg:flex-row lg:justify-between gap-y-5 gap-x-10">
                  ...
                  <div className="lg:w-48">
                    <div className="lg:sticky lg:top-20">
                      <a className="pe-3 group inline-flex items-center gap-x-2 text-start whitespace-nowrap text-sm text-gray-800 rounded-full underline-offset-2 hover:underline hover:decoration-2 focus:outline-hidden focus:underline focus:decoration-2 dark:text-neutral-300" href="../../pro/startup/index.html">
                  ...
                  <div className="lg:max-w-xl w-full">
                    {/* Heading */}
                    <div className="pb-6 mb-6 lg:pb-10 lg:mb-10 lg:last:pb-0 last:mb-0 lg:last:border-b-0 border-b border-gray-200 dark:border-neutral-700">
                      <div className="mb-3 flex items-center gap-x-3">
                        <svg className="shrink-0 size-8" width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M27.462 6.28384C27.44 6.12384 27.2998 6.03529 27.184 6.02554C27.0684 6.01589 24.6215 5.83452 24.6215 5.83452C24.6215 5.83452 22.9221 4.1474 22.7355 3.96066C22.5489 3.77403 22.1844 3.8308 22.0429 3.87244C22.0221 3.87858 21.6716 3.98674 21.0919 4.16614C20.5243 2.53261 19.5224 1.03145 17.7599 1.03145C17.7112 1.03145 17.6611 1.03343 17.611 1.03628C17.1098 0.373373 16.4889 0.0853729 15.9525 0.0853729C11.8468 0.0853729 9.88524 5.21798 9.27023 7.82619C7.67483 8.32055 6.54146 8.672 6.39669 8.71748C5.50617 8.99682 5.47801 9.02488 5.36108 9.864C5.27308 10.4993 2.94299 28.5189 2.94299 28.5189L21.0995 31.9208L30.9373 29.7925C30.9373 29.7925 27.4837 6.44384 27.462 6.28384ZM20.0884 4.4765L18.5521 4.952C18.5526 4.84373 18.5532 4.73721 18.5532 4.62072C18.5532 3.60548 18.4123 2.78806 18.1862 2.14006C19.0943 2.25403 19.6992 3.28735 20.0884 4.4765ZM17.0596 2.34137C17.3121 2.97403 17.4763 3.88198 17.4763 5.10718C17.4763 5.16987 17.4757 5.22718 17.4752 5.28515C16.476 5.59463 15.3903 5.93063 14.3022 6.26773C14.9132 3.90981 16.0584 2.77096 17.0596 2.34137ZM15.8398 1.18663C16.017 1.18663 16.1955 1.2468 16.3663 1.36439C15.0505 1.98356 13.6401 3.54302 13.0445 6.65721L10.5364 7.43398C11.2341 5.05863 12.8907 1.18663 15.8398 1.18663Z" fill="#95BF46"></path><path d="M27.184 6.02553C27.0684 6.01589 24.6215 5.83452 24.6215 5.83452C24.6215 5.83452 22.9221 4.1474 22.7356 3.96066C22.6658 3.89118 22.5716 3.85556 22.4732 3.84022L21.1004 31.9205L30.9373 29.7925C30.9373 29.7925 27.4837 6.44383 27.462 6.28383C27.44 6.12383 27.2999 6.03529 27.184 6.02553Z" fill="#5E8E3E"></path><path d="M17.7599 11.4614L16.5469 15.0697C16.5469 15.0697 15.4841 14.5025 14.1813 14.5025C12.2714 14.5025 12.1753 15.701 12.1753 16.0031C12.1753 17.6511 16.4711 18.2825 16.4711 22.1427C16.4711 25.1797 14.5449 27.1353 11.9476 27.1353C8.83092 27.1353 7.23706 25.1956 7.23706 25.1956L8.07158 22.4384C8.07158 22.4384 9.70994 23.8449 11.0924 23.8449C11.9957 23.8449 12.3632 23.1337 12.3632 22.614C12.3632 20.4643 8.83881 20.3684 8.83881 16.8361C8.83881 13.863 10.9727 10.986 15.2802 10.986C16.94 10.986 17.7599 11.4614 17.7599 11.4614Z" fill="white"></path></svg>
                      ...
                      <h1 className="font-semibold text-2xl lg:text-3xl text-gray-800 dark:text-neutral-200">
                        Rise in E-commerce
                      </h1>
                      ...
                      <div className="mt-8">
                        ...
                        <div className="mt-3 flex flex-wrap gap-y-4 gap-x-10">
                          {/* Avatar Media */}
                          <div className="flex items-center gap-x-3">
                            <img className="shrink-0 size-9 rounded-full grayscale" src="https://images.unsplash.com/photo-1720048169575-b179e1a20dc2?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar" />
                            <div className="grow">
                          ...
                          {/* Avatar Media */}
                          <div className="flex items-center gap-x-3">
                            <img className="shrink-0 size-9 rounded-full grayscale" src="https://images.unsplash.com/photo-1721333087252-e4cffc249d2d?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar" />
                            <div className="grow">
                              <span className="block font-medium text-sm text-gray-800 dark:text-neutral-200">
                                Thomas Moor
                              </span>
                    ...
                    <div className="space-y-7 pb-6 mb-6 lg:pb-10 lg:mb-10 lg:last:pb-0 last:mb-0 lg:last:border-b-0 border-b border-gray-200 dark:border-neutral-700">
                      <p className="text-gray-600 dark:text-neutral-400">
                      ...
                      <ul className="flex flex-col gap-y-1 text-gray-600 dark:text-neutral-400">
                        <li className="flex gap-x-3">
                          <div className="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                      ...
                      <ul className="flex flex-col gap-y-1 text-gray-600 dark:text-neutral-400">
                        <li className="flex gap-x-3">
                          <div className="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                          <div>
                            <span className="font-medium text-gray-800 dark:text-neutral-200">40% Faster Development: </span>
                        ...
                        <li className="flex gap-x-3">
                          <div className="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                          <div>
                            <span className="font-medium text-gray-800 dark:text-neutral-200">90% Component Reuse: </span>
                        ...
                        <li className="flex gap-x-3">
                          <div className="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                          <div>
                            <span className="font-medium text-gray-800 dark:text-neutral-200">30% Fewer Bugs: </span>
                        ...
                        <li className="flex gap-x-3">
                          <div className="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                          <div>
                            <span className="font-medium text-gray-800 dark:text-neutral-200">100% Design Compliance: </span>
                    ...
                    <div className="mb-5">
                      <h4 className="font-semibold text-lg lg:text-xl text-gray-800 dark:text-neutral-200">
                        More stories
                      </h4>
                    </div>
                        ...
                        <div className="mb-3 md:mb-5 flex items-center gap-x-3">
                          ...
                          <div>
                            <span className="flex justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full group-hover:bg-blue-100 group-hover:border-blue-100 group-hover:text-blue-600 group-focus:bg-blue-100 group-focus:border-blue-100 group-focus:text-blue-600 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200 dark:group-hover:bg-blue-800/50 dark:group-hover:border-blue-800/10 dark:group-hover:text-blue-500 dark:group-focus:bg-blue-800/10 dark:group-focus:border-blue-800/50 dark:group-focus:text-blue-500">
                              ...
                              <svg className="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path className="lg:opacity-0 lg:-translate-x-1 lg:group-hover:opacity-100 lg:group-hover:translate-x-0 lg:group-focus:opacity-100 lg:group-focus:translate-x-0 lg:transition lg:duration-200" d="M5 12h14"/><path className="lg:-translate-x-1.5 lg:group-hover:translate-x-0 lg:group-focus:translate-x-0 lg:transition lg:duration-200" d="m12 5 7 7-7 7"/></svg>
                            </span>
                          </div>
                        </div>
                  ...
                  {/* Right Sidebar */}
                  <div className="lg:max-w-3xs w-full lg:border-s border-gray-200 dark:border-neutral-700">
                    {/* Company Info Card */}
                    <div className="lg:sticky lg:top-20 lg:ps-10">
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-1 gap-5">
                        <div>
                          ...
                          <a className="font-mono text-sm text-blue-600 underline underline-offset-2 hover:decoration-2 focus:outline-hidden focus:decoration-2 dark:hover:text-blue-500" href="#">
                            shopify.com
                          </a>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="mt-1 font-mono text-sm text-gray-600 dark:text-neutral-400">
                            E-commerce
                          </p>
                        </div>
