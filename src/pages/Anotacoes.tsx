...
import { Plus, Search, FileText, Bold, Italic, Link, List, AlignLeft, File, Underline, Strikethrough, Quote, Code, Hash, ListOrdered, Image, Highlighter, Undo, Redo, Table, Minus, Heading1, Heading2 } from "lucide-react";
